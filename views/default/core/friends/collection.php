...
$can_message = elgg_trigger_plugin_hook('can_message', 'collection', array('collection_id' => $vars['collection']->id), true);
$can_delete = elgg_trigger_plugin_hook('can_delete', 'collection', array('collection_id' => $vars['collection']->id), true);
...
if ($coll->owner_guid == elgg_get_logged_in_user_guid()) {
	...
	if ($can_message) {
		echo elgg_view('output/url', array(
			'href' => 'friends/collections/message/' . $coll->id,
